# 39.label — PPT two-plane + two-ellipse visualization
...
The RCA component is an inferred candidate, not annotated ground truth. This LCX-only crown-support case has no exported RCA candidate.
...
Selection note: Automatically selected 39.label because its saved combined crown-plus-LAD fit RMSE (6.592724 mm) is lower than 117.label (10.346639 mm).
