...
def run_batch7(args) -> int:
    ...
    print(f" Static Array Shape (geometry_static): [M_branches, 50, 4] (M_branches = 4 to 5)")
    print(f" Cine Array Shape (geometry_cine):   [10, M_branches, 50, 4] (M_branches = 4 to 5)")
